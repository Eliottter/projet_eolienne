...
class MqttPublisher:
    ...
    def publier_donnees(self):
        """Envoie un message MQTT formaté à partir de la dernière donnée BDD"""
        row = self.recuperer_donnees_bdd()
        if row:
            ...
            try:
                ...
                client.tls_insecure_set(True)  # Facultatif avec auto-signé
